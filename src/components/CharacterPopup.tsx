...
export function computePopupRect(
  ...
  switch (position) {
    case "bottom-center": return { x: width / 2 - size / 2, y: height - m - size, w: size, h: size };
    case "bottom-right":  return { x: width - m - size, y: height - m - size, w: size, h: size };
    case "bottom-left":   return { x: m, y: height - m - size, w: size, h: size };
    case "top-center":    return { x: width / 2 - size / 2, y: m, w: size, h: size };
    case "top-right":     return { x: width - m - size, y: m, w: size, h: size };
    case "top-left":      return { x: m, y: m, w: size, h: size };
    case "right-center":  return { x: width - m - size, y: height / 2 - size / 2, w: size, h: size };
    case "left-center":   return { x: m, y: height / 2 - size / 2, w: size, h: size };
  }
}
